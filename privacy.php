...
<head>
    <title>twitterdownloader - Privacy Policy</title>
    <meta name="description" content="In this page you can find our terms of use and privacy policies. If you need any further assistance you contact us any time. TwDown.net the best twitter video downloader.">
...
<body>
    ...
    <div class="navbar navbar-default navbar-static-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php" title="Twitter Downloader Online"><img class="img-responsive" alt="Twitter Video Downloader Online" style="margin-top: -2px;" src="img/logo.png" width="160px"></a>
            </div>
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li><a href="#"><strong>How to Download?</strong></a></li>
    ...
    <div class="jumbotron">
        <div class="container">
            <center>
                <a href="index.php" title="Twitter Video Downloader"><img class="img-responsive" alt="Twitter Video Downloader online" title="Twitter Video Downloader" src="img/twitter-video-downloader-online.png" width="400px"></a>
                <h1 style="font-size:29px;">Twitter Video Downloader</h1>
                <h2 style="font-size:20px;">Privacy Policy and ToS</h2>
                <br />
            </center>
            <div id='ppHeader'>twdown.net Privacy Policy</div>
            <div id='ppBody'>
                ...
                <div class='innerText'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> To improve our website in order to better serve you.</div><span id='coUs'></span><br>
                ...
                <div class='innerText'>If you disable cookies off, some features will be disabled It won't affect the users experience that make your site experience more efficient and some of our services will not function properly.</div><br>
                ...
                <div class='innerText'><br>Opting out:<Br>
                    Users can set preferences for how Google advertises to you using the Google Ad Settings page. Alternatively, you can opt out by visiting the Network Advertising initiative opt out page or permanently using the Google Analytics Opt Out Browser add on.</div><span id='ftcFip'></span><br>
                ...
                <div class='innerText'><strong><br>If at any time you would like to unsubscribe from receiving future emails, you can email us at</strong></div> and we will promptly remove you from <strong>ALL</strong> correspondence.
            </div><br><span id='ourCon'></span><br>
            <div class='blueText'><strong>Contacting Us</strong></div><br />
            <div class='innerText'>If there are any questions regarding this privacy policy you may contact us using the link below.<br><br></div>
            <div class='innerText'>twdown.net/contact.php</div>
            <br />
        </div>
